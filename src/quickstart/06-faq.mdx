...
![Airnote device showing the charging port](/images/guides/airnote/charging-port.webp)
...
![LCD Screen with the charging indicator](/images/guides/airnote/usb-chg.webp)

Once the battery has charged, place the bottom panel back
on the Airnote and secure the panel with the two included
Phillips screws.

![Base panel with screws in place](/images/guides/airnote/base.webp)
...
![How to position an Airnote to display the battery level](/images/guides/airnote/tilt.webp)
...
![LCD Screen with voltage](/images/guides/airnote/voltage.webp)
...
to the back using the instructions [here](/quickstart#mount-it).

### The built-in screen on the Airnote is updating with a lot of information once I power it on. What does it all mean?
...
[Airnote Datasheet](https://dev.blues.com/datasheets/airnote/airnote-datasheet/).
...
the [Airnote Datasheet](https://dev.blues.com/datasheets/airnote/airnote-datasheet/).

### In which countries can the Airnote operate?

The Airnote's built-in cellular connection works in over 135 countries. For
the complete list, see the [Notecard datasheet](https://dev.blues.com/datasheets/notecard-datasheet/note-nbgl-500/#cellular-service).
...
or [manually charge your Airnote](/quickstart#how-can-i-manually-charge-my-airnote).
...
rate on your device's dashboard](/quickstart#scan-the-qr-code-and-customize-your-airnote).
...
transmitting data, you can try [checking its current voltage](/quickstart#can-i-check-the-current-voltage-of-my-airnote),
and [manually charging if necessary](/quickstart#how-can-i-manually-charge-my-airnote).

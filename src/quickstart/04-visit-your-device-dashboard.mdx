...
![Notehub.io events screen for a device](/images/guides/airnote/dashboard-link.webp)

The Airnote dashboard displays current air quality information, as well as historical readings
over the past seven days.

![A sample Airnote device](/images/guides/airnote/dashboard.webp)
...
![Notehub.io events screen for a device](/images/guides/airnote/eventspage.webp)

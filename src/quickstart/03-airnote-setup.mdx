...
any time, you can do so with a micro USB cable.

[See manual charging instructions.](https://dev.blues.io/datasheets/airnote/airnote-quickstart/#how-can-i-manually-charge-my-airnote)
...
**The Airnote is not intended to be set directly on top of a solid surface1**
...
a personalized landing page at [airnote.live](https://airnote.live). From this
screen, you can update device settings, set your contact information, view
charts and graphs for your Airnote, as well as the global network
of Airnote devices. All of the settings and contact information on this
page is optional.

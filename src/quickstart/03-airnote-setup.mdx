...
![Error on landing page](images/guides/airnote/lperror.webp)
...
![Power switch at the base of the Airnote](/images/guides/airnote/switch.webp)

Once you've flipped the switch, look at the LCD screen on the back.

![The location of the LCD screen](images/guides/airnote/lcd-screen.webp)

If you
see anything on the screen, that means the device has started its self-test
sequence, and you're ready for the next step.

![The 3 dots on the LCD during initialization](images/guides/airnote/lcd-init.webp)
...
![Command strips on the device](/images/guides/airnote/commandstrips.webp)
...
![Airnote mounted on an exterior window](images/guides/airnote/window.webp)
...
detailed in the [Airnote Datasheet](https://dev.blues.com/datasheets/airnote/airnote-datasheet/#self-testing-sequence).
...
![Person scanning the Airnote QR code with a phone](images/guides/airnote/scan.webp)
...
![Airnote landing page](images/guides/airnote/airnotelp.webp)
...
![Device settings section of the Airnote landing page](images/guides/airnote/devicesettings.webp)
...
![Owner settings section of the Airnote landing page](/images/guides/airnote/ownersettings.webp)
